...
const Projects = () => {
  return (
    <div className=" flex-col flex gap-30 max-tablet:gap-22 my-[80px]  max-mobile:px-4">
      <div className="cursor-pointer width flex justify-between gap-[20px] max-tablet:flex-col">
        <div className="max-w-[50%] flex flex-col gap-5 max-tablet:w-full max-mobile:gap-3 max-mobile:max-w-[70%]">
          <h2 className="font-bold text-6xl text-transparent stroke-text max-mobile:text-5xl">
            01
          </h2>
          <p className="font-semibold text-[#00FD9A] text-[30px] max-mobile:text-[24px]">
            Netflix Clone
          </p>
        ...
        <div
          ...
          onClick={() =>
            window.open("https://movie-api-delta-dun.vercel.app/", "_blank")
          }
        >
