  ...
  return (
    <div className=" flex-col flex gap-30 max-tablet:gap-22 my-[80px]  max-mobile:px-4">
      <div className="cursor-pointer width flex justify-between items-center gap-[20px] max-tablet:flex-col">
        ...
        <div
          className=" min-w-[50%] flex items-center justify-end relative max-Laptop:w-[50%]  h-fit pt-4 w-[60%] hover:pt-0 transition-all duration-400 ease-in-out max-tablet:w-full max-tablet:justify-center max-tablet:bg-[#3330] max-tablet:transition-none max-tablet:pt-0  max-mobile:max-w-[70%]"
          onClick={() =>
      ...
      <div className="cursor-pointer width flex justify-between items-center gap-[20px] max-tablet:flex-col">
        <div className="max-w-[50%] flex flex-col gap-5 max-tablet:w-full max-mobile:gap-3">
          ...
          <div className="w-[95%] h-[1px] bg-[#BDBDC1] mb-3"></div>
          <div className="flex gap-5 max-tablet:mx-auto max-tablet:my-3 max-mobile:my-0">
            <a href="https://moviesite-ivory-pi.vercel.app/ " target="_blank">
              <div className="text-white hover:text-[#00FD9A] bg-[#33333355] rounded-full p-3">
                <BsArrowUpRight size={23} />
              </div>
            </a>
            <a
              href="https://github.com/michaeljohncodes/moviesite"
              target="_blank"
            >
              <div className="text-white hover:text-[#00FD9A] bg-[#33333355] rounded-full p-3">
                <FaGithub size={23} />
        ...
        <div
          className=" min-w-[50%] flex items-center justify-end relative max-Laptop:w-[50%]  h-fit pt-4 w-[60%] hover:pt-0 transition-all duration-400 ease-in-out max-tablet:w-full max-tablet:justify-center max-tablet:bg-[#3330] max-tablet:transition-none max-tablet:pt-0  max-mobile:max-w-[70%]"
          onClick={() =>
            window.open("https://moviesite-ivory-pi.vercel.app/", "_blank")
          }
        >
          <div className="w-[450px] hover:w-[480px] transition-all duration-400 ease-in-out max-Laptop:hover:w-[450px] max-tablet:transition-none">
            <img src={piggy} alt="" />
      ...
      <div className="cursor-pointer width flex justify-between items-center gap-[20px] max-tablet:flex-col">
        <div className="max-w-[50%] flex flex-col gap-5 max-tablet:w-full max-mobile:gap-3">
          ...
          <div className="flex gap-5 max-tablet:mx-auto max-tablet:my-3 max-mobile:my-0">
            <a
              href="https://calculator-chi-eight-53.vercel.app/  "
              target="_blank"
            >
              <div className="text-white hover:text-[#00FD9A] bg-[#33333355] rounded-full p-3">
                <BsArrowUpRight size={23} />
            ...
            <a
              href="https://github.com/michaeljohncodes/Calculator"
              target="_blank"
            >
              <div className="text-white hover:text-[#00FD9A] bg-[#33333355] rounded-full p-3">
                <FaGithub size={23} />
