...
const SideNavBar = () => {
  ...
  return (
    <div>
      <div className=" w-[100%] flex justify-between items-center bg-[#06141B] text-[#CCD0CF] p-[20px] fixed min-[834px]:hidden ">
      ...
      >
        <div className=" flex flex-col items-center h-[100%] w-[100%] mx-[150px] pt-[100px] gap-y-[10px] ">
          <a href="#Hero">
